...
const realesePayment = require("../routes/realesePayment.js")
const getDriver = require("../routes/gerDriver.js")
...
async function allRoutes(server) {
  ...
  server.register(realesePayment)
  server.register(getDriver)
}
